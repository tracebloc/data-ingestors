...
class Config:
    ...
    SRC_PATH: str = os.getenv("SRC_PATH", "~/Downloads/data-ingestors/data/crowd_monitoring/dataset_voc_512_mini/train") # path to the source data
    ...
    LABEL_FILE: str = os.getenv("LABEL_FILE", "~/Downloads/data-ingestors/data/crowd_monitoring/dataset_voc_512_mini/train/labels_file.csv")
